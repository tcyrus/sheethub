$(document).on('page:change', function() {
    ...
    function renderPage(num) {
        ...
        _.each($('.pdf-canvas-page-num'), function(e) {
            e.textContent = pageNum;
        });
    }
    ...
    _.each($('.pdf-canvas-prev'), function(btn) {
    ...
    _.each($('.pdf-canvas-next'), function(btn) {
    ...
    function loadPDF(url) {
        PDFJS.getDocument(url).then(function(pdfDoc_) {
            ...
            _.each($('.pdf-canvas-page-count'), function(e) {
                e.textContent = pdfDoc.numPages;
            });
